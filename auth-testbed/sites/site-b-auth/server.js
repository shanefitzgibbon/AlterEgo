...
app.get('/login', (req, res) => {
  const returnTo = req.query.returnTo || 'http://app.localtest.me:3012/';
...
<input name="returnTo" value="${returnTo}" />
...
app.post('/login', (req, res) => {
  ...
  const returnTo = req.body.returnTo || 'http://app.localtest.me:3012/';
